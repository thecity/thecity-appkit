CityUtility::Application.configure do
  ...
  config.assets.precompile += %w( application-all.css application-ie.css application-all.js application-ie.js docs.css legacy.css)
end
